...
const Meter_1 = require("../entities/Meter");
const EventMapping_1 = require("../entities/EventMapping");
...
async function seed() {
    ...
    const users = [
        { email: "dev@crm.test", name: "Dev User", role: CRMUser_1.CRMUserRole.DEVELOPER },
        { email: "manager@crm.test", name: "Panel Manager", role: CRMUser_1.CRMUserRole.PANEL_MANAGER },
        { email: "agent1@crm.test", name: "Call Agent One", role: CRMUser_1.CRMUserRole.CALL_AGENT },
        { email: "agent2@crm.test", name: "Call Agent Two", role: CRMUser_1.CRMUserRole.CALL_AGENT },
    ];
    const hashedPass = await (0, encryption_1.hashPassword)("Test@1234");
    ...
    // ── 3. HOUSEHOLDS ─────────────────────────────────────────────────────────────
    console.log("\n🏠 Seeding households...");
    const householdRepo = connection_1.AppDataSource.getRepository(Household_1.Household);
    const households = [
    ...
    for (const h of households) {
        ...
        const hh = householdRepo.create({
            ...
            phoneNumberEncrypted: (0, phone_encryption_1.encryptPhone)(h.phone),
        });
...
//# sourceMappingURL=crm-dev-seed.js.map